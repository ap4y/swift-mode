...
(check-face enum/member-access/has-type-face/1 font-lock-type-face "let foo = .{{Default}}")
(check-face enum/member-access/has-type-face/2 font-lock-type-face "let foo = .{{default}}")
